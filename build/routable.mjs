 ...
 *
 * 70 tools are advertised. Before this, seven had ever been invoked.
 *
 ...
 * workspace: calling 70 tools with no arguments will write a daily note and index
...
const TOOLS = ["agent-hq", "lens", "anvil", "keep", "cortex", "scout", "prism", "recall", "iris"];

/**
 * Is this response a BROKEN tool, or a tool complaining correctly?
 *
 * We call all 70 with no arguments, so most of them SHOULD complain — "query is
